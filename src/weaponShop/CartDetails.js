...
import { CartDetailsRows } from "./CartDetailRows"
...
export class CartDetails extends Component {
    ...
    render() {
        return <div className="m-3">
            <h2 className="text-center">Your insterments of retaliation</h2>
            ...
            <div className="text-center">
                ...
                <Link className={ this.getLinkClasses() } to="/hop/checkout">Checkout</Link>
            </div>
        </div>
    }
}